...
public enum ErrorCode {
    ...
    // COMMON
    NOT_FOUND(HttpStatus.NOT_FOUND.value(), "E003", "Resource not found."),
    INVALID_INPUT_VALUE(HttpStatus.BAD_REQUEST.value(), "E004", "요청값이 유효하지 않습니다."),
    INTERNAL_SERVER_ERROR(HttpStatus.INTERNAL_SERVER_ERROR.value(), "E500", "Internal server error occurred."),
